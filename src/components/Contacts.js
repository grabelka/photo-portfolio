...
function Contacts() {
    return (
        <section>
            ...
            <a href='http://twitter.com'><img className='App-contacts-icon' src={twitter} alt='twitter'/></a>
            <a href='http://telegram.com'><img className='App-contacts-icon' src={telegram} alt='twitter'/></a>
            <a href='http://instagram.com'><img className='App-contacts-icon' src={instagram} alt='twitter'/></a>
            <p>Location:</p>
